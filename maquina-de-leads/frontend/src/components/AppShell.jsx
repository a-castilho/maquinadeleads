...
export default function AppShell() {
  ...
  const sidebarClass = `ml-sidebar${collapsed ? ' is-collapsed' : ''}${mobileOpen ? ' is-mobile-open' : ''}`;
  ...
  return (
    <div className={`ml-app-shell${collapsed ? ' sidebar-collapsed' : ''}`}>
      ...
      <header className="ml-mobile-header">
        <button type="button" className="ml-mobile-menu-button" onClick={() => setMobileOpen(true)} aria-label="Abrir menu">
          ☰
        </button>
